...
import br.com.redemaisfarma.application.service.fiscal.FiscalDocumentService;
import br.com.redemaisfarma.application.service.fiscal.FiscalEmitterConfigService;
...
class AdminConfiguracoesFiscalControllerTest {
    ...
    void formLoadsConfigAndRecentDocuments() {
        when(fiscalEmitterConfigService.load(FiscalProvider.FOCUS_NFE))
                .thenReturn(new FiscalEmitterConfigService.FiscalEmitterConfig(
                        ...
                        "https://redemaisfarma.com/webhooks/fiscal",
                        1,
                        2,
                        true,
                        "000001",
    ...
    void salvarPersistsConfigurationAndRedirectsWithSuccess() {
        ...
        form.setWebhookUrl("https://redemaisfarma.com/webhooks/fiscal");
        form.setNfeSeries(1);

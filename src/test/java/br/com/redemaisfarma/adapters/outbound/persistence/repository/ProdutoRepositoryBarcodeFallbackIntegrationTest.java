...
@SpringBootTest(
        ...
        properties = {
                "spring.datasource.url=jdbc:tc:mysql:8.0.43:///redemaisfarma_test?useSSL=false&useUnicode=true&characterEncoding=UTF-8&serverTimezone=UTC",
...
class ProdutoRepositoryBarcodeFallbackIntegrationTest {
    ...
    @EnableJpaRepositories(basePackages = {
            ...
            "br.com.redemaisfarma.domain.financeiro.mercadopago",

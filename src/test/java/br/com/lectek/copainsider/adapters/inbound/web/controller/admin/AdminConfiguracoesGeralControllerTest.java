...
class AdminConfiguracoesGeralControllerTest {
    ...
    void formAppliesLegacyFallbackAndDefaultValues() {
        ...
        persisted.put("contato.email", "contato@copainsider.com");
        ...
        Assertions.assertThat(cfg.getEmail()).isEqualTo("contato@copainsider.com");
    ...
    void salvarContatoPersistsOnlyContactSection() {
        ...
        verify(settings).upsert("contato.site_url", "https://copainsider.com", "Site oficial");

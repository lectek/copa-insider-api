...
implements Serializable {
    ...
    @Schema(description="E-mail do usu\u00e1rio", example="joao@copainsider.com", requiredMode = Schema.RequiredMode.REQUIRED)
    ...
    @Schema(description="Mensagem de boas-vindas", example="Bem-vindo \u00e0 CopaInsider, Jo\u00e3o!")

// src/main/java/br/com/lectek/copainsider/config/FirebirdDataSourceConfig.java
...
@EnableJpaRepositories(
        basePackages = "br.com.lectek.copainsider.adapters.outbound.legacy.repository",
...
public class FirebirdDataSourceConfig implements EnvironmentAware {
    ...
    public LocalContainerEntityManagerFactoryBean firebirdEntityManagerFactory(
        ...
        emf.setPackagesToScan("br.com.lectek.copainsider.adapters.outbound.legacy.entity");

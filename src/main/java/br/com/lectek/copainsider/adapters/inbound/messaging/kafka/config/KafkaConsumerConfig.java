package br.com.lectek.copainsider.adapters.inbound.messaging.kafka.config;
...
public class KafkaConsumerConfig {
    ...
    public ConsumerFactory<String, PedidoCreatedEventPayLoad> pedidoConsumerFactory() {
        Map<String, Object> props = Map.of(
                ...
                JsonDeserializer.TRUSTED_PACKAGES, "br.com.lectek.copainsider.*",
        ...
        valueDeserializer.addTrustedPackages("br.com.lectek.copainsider");

...
import br.com.lectek.copainsider.adapters.outbound.ai.ollama.OllamaChatClient;
import br.com.lectek.copainsider.application.config.AppAiOllamaProperties;
...
public class OllamaAiAssistantService implements AiAssistantService {
    ...
    private String fallback(
        ...
        if (isNameQuestion(normalized)) {
            return "Eu sou Alysson, o atendente virtual da CopaInsider. Fico por aqui para te ajudar com o que voce precisar.";
        }
    ...
    private static String openingReply() {
        return "Oi! Eu sou Alysson, o atendente virtual da CopaInsider. Estou por aqui para te ajudar com produtos, entrega, pagamento e pedidos.";
    }

...
import br.com.redemaisfarma.domain.fiscal.FiscalPrintJobEventType;
...
public class FiscalPrintQueueService {
    ...
    private boolean supports(
            final br.com.redemaisfarma.domain.fiscal.FiscalPrintStationRole role,
            final FiscalPrintChannel channel
    ) {
        if (role == null
                || role == br.com.redemaisfarma.domain.fiscal.FiscalPrintStationRole.FLEX) {
            return true;
        }
        if (channel == FiscalPrintChannel.IMMEDIATE) {
            return role
                    == br.com.redemaisfarma.domain.fiscal.FiscalPrintStationRole.IMMEDIATE_ONLY;
        }
        return role
                == br.com.redemaisfarma.domain.fiscal.FiscalPrintStationRole.DELIVERY_ONLY;
    }
    ...
    public record PrintJobSummary(
            ...
            String source,
            String stationName,
            br.com.redemaisfarma.domain.fiscal.FiscalDocumentStatus documentStatus,
            String accessKey,
            String danfeUrl,
